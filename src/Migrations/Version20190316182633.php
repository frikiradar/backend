 ...
 */
final class Version20190316182633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat CHANGE fromuser_id fromuser_id INT DEFAULT NULL, CHANGE touser_id touser_id INT DEFAULT NULL, CHANGE time_read time_read DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat CHANGE fromuser_id fromuser_id INT DEFAULT NULL, CHANGE touser_id touser_id INT DEFAULT NULL, CHANGE time_read time_read DATETIME NOT NULL');
