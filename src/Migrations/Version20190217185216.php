 ...
 */
final class Version20190217185216 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tag (name VARCHAR(255) NOT NULL, user_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_389B783A76ED395 (user_id), INDEX IDX_389B78312469DE2 (category_id), PRIMARY KEY(name, user_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(70) NOT NULL, UNIQUE INDEX UNIQ_64C19C15E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
