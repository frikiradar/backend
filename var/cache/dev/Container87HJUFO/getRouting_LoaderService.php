...
$b->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_dir'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotDirService.php')));
$b->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_file'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotFileService.php')));
