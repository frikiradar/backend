...
return $this->services['jms_serializer.metadata_driver'] = new \JMS\Serializer\Metadata\Driver\DoctrineTypeDriver(new \Metadata\Driver\DriverChain(array(0 => new \JMS\Serializer\Metadata\Driver\YamlDriver($a, $b, NULL), 1 => new \JMS\Serializer\Metadata\Driver\XmlDriver($a, $b, NULL), 2 => new \JMS\Serializer\Metadata\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), $b, NULL))), ($this->services['doctrine'] ?? $this->getDoctrineService()));
