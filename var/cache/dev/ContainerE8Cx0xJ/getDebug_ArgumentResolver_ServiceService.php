...
return $this->privates['debug.argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Controller\\ApiController::putAction' => function () {
    return ($this->privates['.service_locator.iuuVGtK'] ?? $this->load('get_ServiceLocator_IuuVGtKService.php'));
}, 'App\\Controller\\ApiController::registerAction' => function () {
...
}, 'App\\Controller\\ApiController:putAction' => function () {
    return ($this->privates['.service_locator.iuuVGtK'] ?? $this->load('get_ServiceLocator_IuuVGtKService.php'));
}, 'App\\Controller\\ApiController:registerAction' => function () {
    return ($this->privates['.service_locator.DcgCYKP'] ?? $this->load('get_ServiceLocator_DcgCYKPService.php'));
}, 'App\\Controller\\ApiController:setViewHandler' => function () {
